...
export const editVehicle = createAction("[Vehicle] - Edit Vehicle", props<{vehicle: IVehicle}>());
export const editVehicleSuccess = createAction("[Vehicle] - Edit Vehicle Success", props<{vehicle: IVehicle}>());
